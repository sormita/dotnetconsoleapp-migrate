...
namespace dotnetapp
{
    class DataTypesExercises : ConsoleReadKeyClearBehavior
    {
        ...
        public static string GetAnalysis(char character)
        {
        ...
        {
            if (attempts > 0)
                Console.WriteLine("\nI said enter a single character. So, just do that.\n");
        ...
        private class TwoNumbers
        {
            ...
            {
                if (attempts > 0)
                    Console.WriteLine("\nI wanted you to enter a whole number. So, just give me that number, babe.");
        ...
        {
            if (attempts > 0)
                Console.WriteLine("\nI just wanted you to do one thing and you couldn't even do that!\n");
